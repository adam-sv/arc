...
const planformOutline: ISegment = {
  ...
  x1: 0,
  x2: CABIN_VIEW_AIRCRAFT_DIMENSIONS.A350.interior.length,
  y1: 0,
  y2: CABIN_VIEW_AIRCRAFT_DIMENSIONS.A350.interior.width,
};
...
const unclippedSegment: ISegment = {
  ...
  x1: -1 * CABIN_VIEW_AIRCRAFT_DIMENSIONS.A350.interior.noseOffset,
  x2: 0,
  y1: 0,
  y2: CABIN_VIEW_AIRCRAFT_DIMENSIONS.A350.exterior.width,
};
...
const yOriginBottomSegment: ISegment = {
  ...
  x1: CABIN_VIEW_AIRCRAFT_DIMENSIONS.A350.interior.noseOffset,
  x2: CABIN_VIEW_AIRCRAFT_DIMENSIONS.A350.interior.length / 3,
  y1: 0,
  y2: CABIN_VIEW_AIRCRAFT_DIMENSIONS.A350.exterior.width / 2,
};
...
const A350CabinViewStory = (): JSX.Element => {
  return (
    <Panel className='cabin-view-story-panel'>
      <CabinView layers={layers} aircraftType='A350' />
    </Panel>
  );
};

export default A350CabinViewStory;
