...
export const ChevronLeft = ({ className }: IChevronProps) => (
  <svg
    className={cn("Icon-chevron", "Icon-chevron-left", className)}
    viewBox="0 0 24 24"
    height="24"
    width="24"
...
export const ChevronRight = ({ className }: IChevronProps) => (
  <svg
    className={cn("Icon-chevron", "Icon-chevron-right", className)}
    viewBox="0 0 24 24"
    height="24"
    width="24"
    xmlns="http://www.w3.org/2000/svg"
...
export const ChevronUp = ({ className }: IChevronProps) => (
  <svg
    className={cn("Icon-chevron", "Icon-chevron-up", className)}
    viewBox="0 0 24 24"
    height="24"
    width="24"
    xmlns="http://www.w3.org/2000/svg"
...
export const ChevronDown = ({ className }: IChevronProps) => (
  <svg
    className={cn("Icon-chevron", "Icon-chevron-down", className)}
    viewBox="0 0 24 24"
    height="24"
    width="24"
    xmlns="http://www.w3.org/2000/svg"
