...
export interface IGeometry {
  // vector math
  addVector: (vec1: ICoords, vec2: ICoords, scale1?: number, scale2?: number) => ICoords;
  ...
  getClosestPointsBetweenRects: (rect: DOMRect, anotherRect: DOMRect, mode: 'midpoints' | 'corners' | 'midpoints-corners') => [ICoords, ICoords];
  getClosestPointToAnotherRect: (rect: DOMRect, anotherRect: DOMRect) => ICoords;
...
export function addVector(vec1: ICoords, vec2: ICoords, scale1?: number, scale2?: number): ICoords {
  scale1 = scale1 || 1;
  scale2 = scale2 || 1;
...
export function getClosestPointToAnotherRect(rect: DOMRect, anotherRect: DOMRect): ICoords {
